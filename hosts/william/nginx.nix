...
}:
{
  ...
  sops.secrets."william-nginx-web-authfile".owner = config.services.nginx.user;
  ...
  services.nginx.virtualHosts =
    ...
    in
    {
      ...
      "home.${configVars.domain}" = {
        ...
        http2 = true;
        forceSSL = true;
        basicAuthFile = config.sops.secrets."william-nginx-web-authfile".path;
      ...
      "localhost" = {
        serverAliases = [
          ...
          configVars.networking.subnets.wiliam.ip
        ];
